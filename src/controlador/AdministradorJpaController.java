...
public class AdministradorJpaController implements Serializable {
    ...
    public void create(Administrador administrador) {
        ...
        try {
            ...
            Persona personaId = administrador.getPersonaId();
            if (personaId != null) {
                personaId = em.getReference(personaId.getClass(), personaId.getId());
                administrador.setPersonaId(personaId);
            }
            em.persist(administrador);
            if (personaId != null) {
                personaId.getAdministradorCollection().add(administrador);
    ...
    public void edit(Administrador administrador) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Persona personaIdOld = persistentAdministrador.getPersonaId();
            Persona personaIdNew = administrador.getPersonaId();
            if (personaIdNew != null) {
                personaIdNew = em.getReference(personaIdNew.getClass(), personaIdNew.getId());
                administrador.setPersonaId(personaIdNew);
            }
            administrador = em.merge(administrador);
            if (personaIdOld != null && !personaIdOld.equals(personaIdNew)) {
                personaIdOld.getAdministradorCollection().remove(administrador);
                personaIdOld = em.merge(personaIdOld);
            }
            if (personaIdNew != null && !personaIdNew.equals(personaIdOld)) {
                personaIdNew.getAdministradorCollection().add(administrador);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Persona personaId = administrador.getPersonaId();
            if (personaId != null) {
                personaId.getAdministradorCollection().remove(administrador);
                personaId = em.merge(personaId);
            }
